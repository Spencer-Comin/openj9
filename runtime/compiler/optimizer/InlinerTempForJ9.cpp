...
TR_J9InlinerPolicy::createUnsafePutWithOffset(TR::ResolvedMethodSymbol *calleeSymbol,
                                              ...
                                              bool isUnaligned)
   {
   if (ordering != TR::Symbol::TransparentSemantics && type == TR::Int64 && comp()->target().is32Bit() && !comp()->cg()->getSupportsInlinedAtomicLongVolatiles())
      return false;
...
TR_J9InlinerPolicy::inlineUnsafeCall(TR::ResolvedMethodSymbol *calleeSymbol, TR::ResolvedMethodSymbol *callerSymbol, TR::TreeTop * callNodeTreeTop, TR::Node * callNode)
   ...
   switch (callNode->getSymbol()->castToResolvedMethodSymbol()->getRecognizedMethod())
      ...
      case TR::sun_misc_Unsafe_putObject_jlObjectJjlObject_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::TransparentSemantics, true);
      ...
      case TR::sun_misc_Unsafe_getObject_jlObjectJ_jlObject:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::TransparentSemantics, true);

      case TR::sun_misc_Unsafe_putByteVolatile_jlObjectJB_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putBooleanVolatile_jlObjectJZ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putCharVolatile_jlObjectJC_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putShortVolatile_jlObjectJS_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putIntVolatile_jlObjectJI_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putLongVolatile_jlObjectJJ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putFloatVolatile_jlObjectJF_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putDoubleVolatile_jlObjectJD_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_putObjectVolatile_jlObjectJjlObject_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::VolatileSemantics, true);

      case TR::sun_misc_Unsafe_getBooleanVolatile_jlObjectJ_Z:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getByteVolatile_jlObjectJ_B:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getCharVolatile_jlObjectJ_C:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getShortVolatile_jlObjectJ_S:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getIntVolatile_jlObjectJ_I:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getLongVolatile_jlObjectJ_J:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getFloatVolatile_jlObjectJ_F:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getDoubleVolatile_jlObjectJ_D:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::VolatileSemantics);
      case TR::sun_misc_Unsafe_getObjectVolatile_jlObjectJ_jlObject:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::VolatileSemantics, true);
      ...
      case TR::sun_misc_Unsafe_putByteOrdered_jlObjectJB_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putBooleanOrdered_jlObjectJZ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putCharOrdered_jlObjectJC_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putShortOrdered_jlObjectJS_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putIntOrdered_jlObjectJI_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putLongOrdered_jlObjectJJ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putFloatOrdered_jlObjectJF_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putDoubleOrdered_jlObjectJD_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::AcquireReleaseSemantics);
      case TR::sun_misc_Unsafe_putObjectOrdered_jlObjectJjlObject_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::AcquireReleaseSemantics, true);

      // FIXME: Update createUnsafePutWithOffset signature to have isVolatile, isOrdered, isUnaligned as enum
      case TR::jdk_internal_misc_Unsafe_getCharUnaligned:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_getShortUnaligned:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_getIntUnaligned:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_getLongUnaligned:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_putCharUnaligned:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_putShortUnaligned:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_putIntUnaligned:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);
      case TR::jdk_internal_misc_Unsafe_putLongUnaligned:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::TransparentSemantics, /*needsNullCheck*/false, /*isUnaligned*/true);

      case TR::jdk_internal_misc_Unsafe_getBooleanAcquire_jlObjectJ_Z:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getByteAcquire_jlObjectJ_B:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getCharAcquire_jlObjectJ_C:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getShortAcquire_jlObjectJ_S:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getIntAcquire_jlObjectJ_I:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getLongAcquire_jlObjectJ_J:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getFloatAcquire_jlObjectJ_F:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getDoubleAcquire_jlObjectJ_D:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::AcquireReleaseSemantics);
      case TR::jdk_internal_misc_Unsafe_getReferenceAcquire_jlObjectJ_jlObject:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::AcquireReleaseSemantics, true);

      case TR::jdk_internal_misc_Unsafe_getBooleanOpaque_jlObjectJ_Z:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getByteOpaque_jlObjectJ_B:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getCharOpaque_jlObjectJ_C:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getShortOpaque_jlObjectJ_S:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getIntOpaque_jlObjectJ_I:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getLongOpaque_jlObjectJ_J:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getFloatOpaque_jlObjectJ_F:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getDoubleOpaque_jlObjectJ_D:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_getReferenceOpaque_jlObjectJ_jlObject:
         return createUnsafeGetWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::OpaqueSemantics, true);

      case TR::jdk_internal_misc_Unsafe_putBooleanOpaque_jlObjectJZ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putByteOpaque_jlObjectJB_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int8, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putCharOpaque_jlObjectJC_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putShortOpaque_jlObjectJS_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int16, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putIntOpaque_jlObjectJI_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int32, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putLongOpaque_jlObjectJJ_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Int64, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putFloatOpaque_jlObjectJF_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Float, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putDoubleOpaque_jlObjectJD_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Double, TR::Symbol::OpaqueSemantics);
      case TR::jdk_internal_misc_Unsafe_putReferenceOpaque_jlObjectJjlObject_V:
         return createUnsafePutWithOffset(calleeSymbol, callerSymbol, callNodeTreeTop, callNode, TR::Address, TR::Symbol::OpaqueSemantics, true);
